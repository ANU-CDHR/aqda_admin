...
class NarratorController extends RestController
{
    public $modelClass = 'api\modules\d1\models\Narrator';
    ...
    public function init()
    {
        ...
        if(class_exists('api\modules\d1\models\Narrator'))
            $this->modelClass = 'api\modules\d1\models\Narrator';
        else
		...
		$actions['index'] = [
			...
			'prepareDataProvider' => function () {
                ...
                $filter = new ActiveDataFilter([
                    'searchModel' => 'api\modules\d1\models\NarratorSearch',
                    'attributeMap'=> [ 'id'=>'interviewee.id']
                ]);
