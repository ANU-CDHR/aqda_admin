...
use api\modules\d1\models\SexoSearch;

//class InterviewController extends ActiveController
class SexoController extends RestController
{
    public $modelClass = 'api\modules\d1\models\Sexo';
    ...
    public function init()
    {
        ...
        if(class_exists('api\modules\d1\models\Sexo'))
            $this->modelClass = 'api\modules\d1\models\Sexo';
        else
		...
		$actions['index'] = [
			...
			'prepareDataProvider' => function () {
                ...
                $filter = new ActiveDataFilter([
                    'searchModel' => 'api\modules\d1\models\SexoSearch',
    ...
    {
        //return User::findOne($id)->where(['published'=>0]);
    }
