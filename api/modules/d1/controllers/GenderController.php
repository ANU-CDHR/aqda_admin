...
class GenderController extends RestController
{
    public $modelClass = 'api\modules\d1\models\Gender';
    ...
    public function init()
    {
        ...
        if(class_exists('api\modules\d1\models\Gender'))
            $this->modelClass = 'api\modules\d1\models\Gender';
        else
    ...
    public function actions()
    {
		...
		$actions['index'] = [
			...
			'prepareDataProvider' => function () {
                ...
                $filter = new ActiveDataFilter([
                    'searchModel' => 'api\modules\d1\models\GenderSearch',
        ...
        $actions['view'] = [
            ...
            'findModel' => static function ($id, \yii\rest\ViewAction $action) {
                ...
                $model = $query->where(['gender.id'=>$id])->one();
