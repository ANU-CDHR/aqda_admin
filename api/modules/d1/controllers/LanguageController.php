...
{
    public $modelClass = 'api\modules\d1\models\Language';
    ...
    public function init()
    {
        ...
        if(class_exists('api\modules\d1\models\Language'))
            $this->modelClass = 'api\modules\d1\models\Language';
        else
    ...
    public function actions()
    {
		...
		$actions['index'] = [
			...
			'prepareDataProvider' => function () {
                ...
                $filter = new ActiveDataFilter([
                    'searchModel' => 'api\modules\d1\models\LanguageSearch',
        ...
        $actions['view'] = [
            ...
            'findModel' => static function ($id, \yii\rest\ViewAction $action) {
                ...
                $model = $query->where(['language.id'=>$id])->one();
