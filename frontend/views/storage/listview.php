...
//$this->title = $model->id;
$this->title = 'Interview: ' . $publishMedia->interview->accessionName.' Publish Media '.$publishMedia->id.', Storage '.$model->id;
...
echo Tabs::widget([
    ...
    'items' => [
        ...
        [
            ...
            'items' => [
                [
                    'label' => 'Storage '.Html::encode($this->title),
                    'content' => '',
                    'active' => true,
                ],
                [
...
<p>
    ...
    <?php // Html::a('Storages', ['list', 'mediaId' => $mediaId,'interviewId' => $interviewId], ['class' => 'btn btn-primary']) ?>
</p>
...
<div class="storage-view">
    ...
    <h1><?= "Storage ".Html::encode($model->id) ?></h1>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'format' => 'raw',  
                'attribute' => 'storageType',      
                'value' => function ($model, $key) use ($storageTypes)
                {
                    return $storageTypes[$model->storageType];
                },
            ],
